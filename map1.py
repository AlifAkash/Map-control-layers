...
for lt, ln, el, name in zip(lat, lon, elev, name):
    ...
    fgv.add_child(folium.CircleMarker(location=[lt, ln], radius= 6, popup= folium.Popup(iframe), color = "gray", fill_color = color_producer(el), fill_opacity= 0.7, fill = True))
